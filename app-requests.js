...
// بنسخة workshop-mini-simple-ui.js (وهي الشغالة فعليًا هناك). صفحات تانية
// (زي request.html وroute.html) بتستخدم النسخة دي كما هي. أي تعديل في شرط
// الإغلاق أو الحقول المسجَّلة لازم يتعمل في النسختين مع بعض.
